...
?>
	<div class="container">
        ...
        <div class="text-center">
                    <a href="http://www.facebook.com/sharer.php?u=http://pkl.code.redwhite.co.id/kitel/<?php echo'berita-'.$r['nama'].'-'.$r['id_content'];?>" target="_blank" class="btn btn-social-icon btn-facebook">
                        <i class="fa fa-facebook"></i>
                    </a>

                    <a href="https://plus.google.com/share?url=http://pkl.code.redwhite.co.id/kitel/<?php echo'berita-'.$r['nama'].'-'.$r['id_content'];?>" target="_blank"class="btn btn-social-icon btn-google-plus">
                        <i class="fa fa-google-plus"></i>
                    </a>
                    
                    <a class="btn btn-social-icon btn-instagram"><i class="fa fa-instagram"></i></a>
                    
                    <a href="https://twitter.com/share?url=http://pkl.code.redwhite.co.id/kitel/<?php echo'berita-'.$r['nama'].'-'.$r['id_content'];?>&text=Berita%20Korea%20Share&hashtags=beritakorea" target="_blank" class="btn btn-social-icon btn-twitter">
