    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Admin</b> Korea</span>
        </a>
...
$menu = mysql_query("SELECT * FROM pages where status = 2");
?>
      ...
      echo '<li>
              <a href="'.$menus['link'].'">
                <i class="fa fa-th"></i> <span>'.$menus['menu'].'</span>
              </a>
            </li>';
			?>
          </ul>
